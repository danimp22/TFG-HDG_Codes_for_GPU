...
def hdgMatrixPoisson(muElem, X, T, F, referenceElement, infoFaces, tau):
    ...
    Qf = [None] * nOfElements
    Uf = [None] * nOfElements
    KKe_cells = [None] * nOfElements
    All_cells = [None] * nOfElements
    ...
    for iElem in range(nOfElements):
        ...
        KKe_cells[iElem] = csr_matrix(KKe)  
        All_cells[iElem] = csr_matrix(All) 
    ...
    return KK, f, QQ, UU, Qf, Uf, KKe_cells, All_cells
